...
echo -e "${GREEN}======================================================${NC}"
echo -e "👉 ${CYAN}Frontend UI       :${NC} http://localhost:4003"
echo -e "👉 ${CYAN}Backend REST API  :${NC} http://localhost:8083/api/users"
echo -e "👉 ${CYAN}PostgreSQL DB     :${NC} localhost:5003 (DB: fooddelivery03)"
echo -e "${GREEN}======================================================${NC}"
